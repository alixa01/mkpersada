...
export default function HeroSection() {
  ...
  return (
    <section
      ref={pinRef}
      id="hero"
      className="relative overflow-hidden min-h-screen bg-[url('/hero/hero-bg.jpg')] bg-cover bg-center">
      {/* overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#194670]/50 to-[#194670]"></div>

      {/* content */}
      <div className="relative z-10 pt-[76px] flex flex-col items-center min-h-screen px-4 sm:px-6 md:px-8">
        {/* innovating bar */}
        <motion.span
          variants={fadeDown}
          initial="hidden"
