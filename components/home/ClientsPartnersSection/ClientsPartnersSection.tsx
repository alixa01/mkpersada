...
function LogosRow({ title, logos, direction, ariaLabel }: LogosRowProps) {
  return (
...
export default function ClientsPartnersSection() {
  return (
    <section
      id="clients-partners"
      className="min-h-[420px] bg-[linear-gradient(135deg,#e6f0fa_0%,#c9dff2_40%,#b1cee7_100%)] text-[#194670] relative overflow-hidden">
      {/* content */}
