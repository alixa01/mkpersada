...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center bg-[#243A55] text-footer-text/90 py-8 sm:py-10 md:py-12 relative z-40">
      {/* main footer */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
            <p className="text-[14px] font-normal leading-[22px] tracking-[0.28px] text-center sm:text-left">
              &copy; 2025 PT Mitra Kencana Persada. All rights reserved.
            </p>
