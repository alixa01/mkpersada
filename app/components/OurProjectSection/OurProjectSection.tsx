...
export default function OurProjectSection() {
  ...
  return (
    <section
      id="our-project"
      className="flex items-center flex-col gap-8 w-full h-[600px] bg-[radial-gradient(circle_at_50%_-10%,#83A0BC_0%,#194670_70%)] py-10">
      <div className="flex items-center">
        <motion.h1
          ...
          className="mt-0 md:mt-4 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight text-slate-100 drop-shadow-lg">
          our current project
        </motion.h1>
      </div>
        ...
        <AnimatePresence>
          {hoveredIndex !== null && (
            <motion.div
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-primary/40 to-primary/80 rounded-2xl"></div>
